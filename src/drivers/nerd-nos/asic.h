...
protected:
    ...
    bool receiveWork(uint16_t timeout, asic_result_t *result);
...
public:
    ...
    uint8_t sendWork(uint32_t job_id, bm_job_t *next_bm_job);
    bool processWork(uint16_t timeout, task_result *result);
